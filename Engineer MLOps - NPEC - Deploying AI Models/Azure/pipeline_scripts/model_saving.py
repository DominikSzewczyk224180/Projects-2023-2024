...
def save_model(model: tf.keras.Model, model_name: str, folder_path: str) -> str:
    """
    Written by Dominik, modified by Matey
    ...
    logging.info(f"Model saved successfully at {folder_path}")
    return folder_path
