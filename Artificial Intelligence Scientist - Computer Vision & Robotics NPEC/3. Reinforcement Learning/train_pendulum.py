...
# task = Task.init(project_name='Mentor Group J/Group 2', task_name='Experiment1')
...
# python "3. Reinforcement Learning\train_pendulum.py" --learning_rate 0.0001 --batch_size 64 --n_steps 2048 --n_epochs 10
